...
//Objeto Categorias
const categorias = {
    frutas: ["manga", "abacate", "tangerina"],
    animais: ["vaca", "gato", "galinha"]
};
...
function ocultaPalavra(){
    ...
    exibePalavraInterface(palavraEscondida);
}
...
function verificaFimDeJogo(){
    if(!palavraInterface.innerHTML.includes("-")){
        ...
        window.removeEventListener("keypress", retornaLetra); //Finaliza o evento do teclado
    }else if(letrasErradasArray.length >= numTentativas){
        desenhaOlhos();
        exibePalavraInterface("Você perdeu! Que pena!");
